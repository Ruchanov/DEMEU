...
from .views import publication_list, publication_detail, donation_create, top_donors, list_documents, upload_document, \
    delete_document, recommended_publications, update_document
...
urlpatterns = [
    ...
    path('<int:publication_id>/documents/<int:document_id>/update/', update_document, name='document-update'),
    path('<int:publication_id>/documents/<int:document_id>/delete/', delete_document, name='document-delete'),
